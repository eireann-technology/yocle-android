...
package com.invest.yocle;
    ...
    public class MyVideoPlayer extends Activity {
        ...
        protected void onCreate(final Bundle savedInstanceState) {
            ...
            if (e!=null) {
                video_url = e.getString("video_url");
            }

            //set the media controller buttons
            if (mediaControls == null) {
                mediaControls = new MediaController(MyVideoPlayer.this);
            }
            ...
            progressDialog = new ProgressDialog(MyVideoPlayer.this);
        ...
        protected void onResume() {
            ...
            if(g_savedInstanceState!=null) {
                onRestoreInstanceState(g_savedInstanceState);
        ...
        public void onSaveInstanceState(Bundle savedInstanceState) {
            ...
            int pos = myVideoView.getCurrentPosition();
            pos = currentPosition;
